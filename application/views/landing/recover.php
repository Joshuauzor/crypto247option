...
<body>
 ...
 <div class="slider-area slider-area3">
            <div class="slider-items" >
                <img src="<?=base_url('assets/images/slider/1.jpg')?>" alt="" style=" background-color:red" class="slider">
                <div class="slider-content flex-style" style="padding-bottom: 15%;">
					...
					<div class="col-md-6" id="babe">
								...
								<form action="<?=base_url('client/login/recover')?>" method="POST" id="form" class="_l_frm _formm__" enctype="multipart/form-data">

									<div class="_oe_frm_hd" style="padding-top: 3%;">Recovery</div>
                                    ...
                                    <label class="_oe_lab">phone</label>
                                    <input type="phone" name="phone" value="" placeholder="" class="_oe_inp" required>
                                    
						        	<label class="_oe_lab">New Password</label>
						        	<input type="password" name="password" placeholder="New password" class="_oe_inp" required>
							        
                                    <label class="_oe_lab">Confirm New Password</label>
                                    <input type="password" name="confirm_pass" placeholder="Confirm New password" class="_oe_inp" required>
