					...
					<!-- <div class="col-md-6">
						...
						._oe_frm_hd{
							...
							margin-bottom: 20px;
								...
								<form action="" method="POST" class="_l_frm _formm__" enctype="multipart/form-data">

									<div class="_oe_frm_hd">OPEN ACCOUNT</div>

																		
						        	<label class="_oe_lab">Full Name</label>
						        	<input type="text" name="r_full_name" value="" placeholder="e.g. John Doe" class="_oe_inp">
							        
						        	<label class="_oe_lab">Email</label>
						        	<input type="email" name="r_mail" value="" placeholder="example@mail.com" class="_oe_inp">

						        	<label class="_oe_lab">Sex</label>
						        	<select class="_oe_inp" name="r_sex">
						        		<option>--- Select Sex ---</option>
						        		 <option value="Male">Male</option>  <option value="Female">Female</option> 						        	</select>

						        	<label class="_oe_lab">Trading Currency</label>
						        	<select class="_oe_inp" name="r_currency">
						        	...
						        	<input type="password" name="password" placeholder="password" class="_oe_inp">
							        
						        	<label class="_oe_lab">Confirm Password</label>
						        	<input type="password" name="r_password" placeholder="Re-type password" class="_oe_inp">
							        
						        	<label class="_oe_lab">Phone Number</label>
						        	<input type="text" name="r_phone" value="" placeholder="+1XXX XXXX XXXX" class="_oe_inp">
							        
						        	<label class="_oe_lab">Country</label>
						        	<select class="_oe_inp" name="r_country">
