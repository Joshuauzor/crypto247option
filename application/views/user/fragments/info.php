                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="mb-0 text-muted">
                                            <i class="fa fa-caret-down text-danger m-r-5"></i>Withdrawals
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <div class="font-size-30 mb-1 font-weight-bold text-primary">$<?= $transaction->balance; ?></div>
                                        <p class="mb-0 text-muted">
                                            <i class="fa fa-caret-up text-primary m-r-5"></i> trade ongoing
                                        </p>
                                    </div>
                                </div>
                            </div>
