...
<div class="form-wrapper">
    ...
    <form action="<?=base_url('client/login')?>" method="POST">
        ...
        <div class="form-group d-flex justify-content-between">
            ...
            <a href="<?= base_url('client/login/change_password') ?>">Forgot password?</a>
        </div>
        <button class="btn btn-primary btn-block">Sign in</button>
        <div id="text">
            <p>By signing in means that you agree with terms and conditions and our privacy policy including our cookie. We keep your data secured.</p>
        </div>
        <hr>
