                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/home/wallet') ?>" method="POST">
                                ...
                                <p>Update the wallet ID below </p>
                                </div>
                                <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                    <label for="exampleFormControlInput1">Wallet ID</label>
                                    <input type="text" class="form-control" name="wallet" value="<?=$wallet->address ?>" id="exampleFormControlInput1"
